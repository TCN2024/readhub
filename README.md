...
#### ReadHub - Library Management is a web application built with Django, Razorpay, and Tailwind CSS that provides an online platform for managing libraries.
> 
...
5.  can see
    ...
    - the days remaining to return a particular book
      **or**
    - the number of days passed the return date of a particular book in my fines page

6.  Pay their fines online (powered by RazorPay) (Yet to be implemented)
...
#### If you'd like to contribute our ReadHub Library Management, feel free to fork this repository and submit a pull request. For more information on contributing to the project, please check out our repository.
...
#### ReadHub Library Management was created by TCN2024
